...
const commentText = (signed, badgeUrl, claUrl, userMap, recheckUrl, migrationNotice) => {
    ...
    let text = `[![CLA assistant check](${badgeUrl})](${claUrl}) <br/>Thank you for your submission! We ask that ${youAll} sign our [Contributor License Agreement](${claUrl}) before we can accept your contribution.<br/>`
